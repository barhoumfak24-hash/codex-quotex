  ...
  function handleCarrierView() {
    ...
    showDemoNotice({
      ...
      body: `In production, this opens ${
        ...
        livePolicy
      )} so you can view and service the policy directly in the carrier's system. Configure the carrier's agent portal URL under Master → Carriers to enable this link in the demo.`,
    });
  }
