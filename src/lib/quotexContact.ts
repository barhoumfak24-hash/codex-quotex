...
export const QUOTEX_SUPPORT_EMAIL_HREF = `mailto:${QUOTEX_SUPPORT_EMAIL}`;
export const QUOTEX_CONTACT_PHONE = "517-294-2671";
export const QUOTEX_CONTACT_PHONE_HREF = "tel:+15172942671";
